...
set Period_ns 8             ;# desired clock period (in ns) (sets speed goal)
...
set Area 1800   	     ; # Max area

# Define compiler
set useUltra 1               ;# 1 for compile_ultra, 0 for simple compile
...
create_clock -period $Period_ns -waveform {0 4} $Clk
